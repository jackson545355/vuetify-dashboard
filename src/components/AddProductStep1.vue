<template>
    <v-card flat>
        <v-container>
            <v-form ref="form">
                <v-card-text>
                    <h1>We need some information about the new product!</h1>
                    <br />
                    <h2>Basic</h2>
                    <br />
                    ...
                    <v-select :items="technologyFrameworks" label="Technology Frameworks" v-model="technologyFramework"
                        required variant="solo" :rules="[v => !!v || 'Technology Frameworks is required']"></v-select>
                    ...
                    <h4 style="color: grey; text-align:center;">Click the button below to submit the product
                        information.
                    </h4>
                </v-card-text>
            </v-form>
